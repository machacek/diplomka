...
to use Pearson correlation coefficient as the main measure this year. At the
end of this section we give reasons for this change. 
...
previous years, we have also compute and report Spearman rank correlation
coefficient in the tables. This metaevaluation measure \XXX{Dodelat a uvest vzorec
pro vypocet Spearmanovy korelace}
