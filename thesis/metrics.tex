...
\parcite{wmt14-metric-upc} combine various metrics implemented in the
\textsc{Asiya} toolkit.\footnote{\url{http://nlp.lsi.upc.edu/asiya/}}. The set
of metrics they use contains 6 lexical based metrics (\metric{WER},
...
\metric{UPC-STOUT}.  It considers only metrics which require no or little
language resources.
