\chapter{SegRanks - An Evaluation of Short Segments}

In the following two chapters we propose a novel manual evaluation method in
which we create a database of collected human annotations which could be reused
later to automatically evaluate similar, but yet unseen, translations or even
...
chapter we present few methods which exploit the collected database: besides
