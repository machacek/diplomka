...
annotation application, for example Appraise\XXX{citovat}. However, since
...
\XXX{Annotacni prostredi, ukazka prostredi, zduraznit jednoduchost, odkazat se
na implementaci, instrukce k anotovani, anotatori,  prubeh anotace, statistiky analyza
...
guess from the candidate). Also please rank the acceptable candidate
