...
\noindent where $P(A>B)$, $P(A=B)$ and $P(A<B)$ were computed empirically.
...
better than they are in WMT14. However, they are still quite poor\footnote{
The exact interpretation of the kappa coefficient is difficult, but according
to \cite{koch1977}, 0 -- 0.2 is slight, 0.2 -- 0.4 is fair, 0.4 -- 0.6 is moderate,
0.6 -- 0.8 is substantial and 0.8 -- 1.0 is almost perfect.} and we expected
them higher.
