...
\begin{table}
  \begin{center}
    \subfloat[Comparisons in which a given system was better]{
      \begin{tabular}{|l|c|}
        \hline
         System                   &   $\tau$ \\
        \hline
        ...
        \hline
      \end{tabular}
      \label{judgements-better}
    }

    \subfloat[Comparisons in which a given system was worse]{
      \begin{tabular}{|l|c|}
        \hline
         System                   &   $\tau$ \\
       \hline
        ...
        \hline
      \end{tabular}
      \label{judgements-worse}
    }

    \subfloat[All comparisons]{
      \begin{tabular}{|l|c|}
        \hline
         System                   &   $\tau$ \\
        \hline
        ...
        \hline
      \end{tabular}
      \label{judgements-all}
    }
  \end{center}

  \caption{jlfdsjflsjflsj fldjf lsj dfld fdjflf jlsd jfslf jsl fjsldf jslf jsldf jsldfjsldfjlsd ld fjsld fj}
  \label{}
\end{table}
