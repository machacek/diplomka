...
\XXX{citace}. We used \texttt{englishFactored} model which is distributed with
...
We extracted short segments from the parsed source trees and project
them using the computed alignment. In algorithm \ref{segment:extraction}, 
