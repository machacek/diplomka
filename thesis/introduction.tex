...
correlation to human judgments varies a lot. The first goal in this thesis is
...
during evaluation. We describe some of these methods in Related Work and
propose a similar method. The goal here is to design a method which could be
used as an effective and simple-for-annotators manual evaluation and in the
same time the database collected during the annotation could be used later to
evaluate new unseen segments. 


\section{Outline}

\XXX{Rozhodnout se nejdriv o poradi kapitol.}
