...
Indipendent machine translation systems often translate a short source segment
...
\metoda{Ratio of wins (ignoring ties)} only on the hits. Because we didn't havy
...
of a segment than on a bad translation. To support this statement we have
performed an analysis of some sentences from the test set.
