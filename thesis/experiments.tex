...
MERT method is most often used with the BLEU metric even it does not have the
best correlation with human judgments (please see the chapter \ref{metrics} for
more details). However, there is a lot of experiments with utilizing also other
...
Our original idea was that we will use the alignment produced by 
