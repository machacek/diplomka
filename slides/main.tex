...
\begin{frame}{WMT Official Evaluation}
    \begin{itemize}
...
\begin{frame}{SegRanks - The Proposed Method}
    \begin{itemize}
...
\begin{frame}{Annotator Agreements}
    \begin{itemize}
        \item To estimate robustness of the annotation method, I measured annotator agreements
        \item The agreements were normalized using Coehn's $\kappa$
    \end{itemize}
        \begin{cvarblock}[5cm]{Coehn's $\kappa$}
        \begin{center}
            \begin{equation*}
